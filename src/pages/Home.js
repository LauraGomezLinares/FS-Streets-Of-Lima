...
function Home() {
    ...
    return (
        <div className="background relative flex flex-col items-center w-full bg-[#0a0a0a] text-white font-dogica pt-8">            
            ...
            <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-8 mb-16">
                ...
                <div className="col-span-1 lg:col-span-2 flex flex-col items-center justify-center">
                    ...
                    <div className="flex gap-4 mb-10">
                        {/* Tu cuadrado */}
                        <div className="w-16 h-16 md:w-20 md:h-20 bg-zinc-800 border-2 border-yellow-400 rounded flex items-center justify-center relative shadow-[0_0_15px_rgba(255,220,50,0.3)]">
                            <img src={faceSprite} alt="You" className="w-full h-full object-cover rendering-pixelated" />
                            <div className="absolute -top-2 -right-2 bg-yellow-400 text-black text-[8px] px-1 rounded">P1</div>
                        </div>
                        {/* Cuadrados de Invitación */}
                        {[2, 3, 4].map((num) => (
                            <button 
                                key={num}
                            ...
                            >
                                ...
                                <div className="absolute -top-2 -right-2 bg-zinc-800 text-zinc-500 text-[8px] px-1 rounded border border-zinc-700">P{num}</div>
                            </button>
                        ))}
                    </div>
                ...
                <div className="col-span-1 flex flex-col items-center justify-start pt-4">
                    ...
                    <div className="w-full max-w-[250px] aspect-[3/4] bg-[#111] border border-zinc-800 rounded relative mb-4 flex items-center justify-center overflow-hidden">
                        ...
                        <img 
                            src={idleGif} 
                            alt="Idle Character" 
                            className="relative z-10 w-full h-full object-contain rendering-pixelated filter drop-shadow-[0_0_15px_rgba(255,220,50,0.3)]" 
                        />
                    </div>
                    ...
                    <div className="w-full max-w-[250px]">
                        ...
                        {isSkillTreeOpen && user && (
                            <div className="w-full bg-[#111] border border-zinc-800 border-t-0 p-3 rounded-b flex flex-col gap-2">
                                ...
                                <button className="bg-zinc-800 border border-zinc-600 text-[9px] p-2 hover:border-yellow-400 text-left">
                                    [+] DASH MASTERY
                                </button>
                                <button className="bg-zinc-800 border border-zinc-600 text-[9px] p-2 hover:border-yellow-400 text-left">
                                    [+] HEAVY PUNCH
