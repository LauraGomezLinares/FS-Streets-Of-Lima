...
// Cuando tengas las imágenes, las importas aquí:
// import imgPack1 from '../assets/sunnys_tier1.png';
// import imgPack2 from '../assets/sunnys_tier2.png';
// import imgPack3 from '../assets/sunnys_tier3.png';
// import imgPack4 from '../assets/sunnys_tier4.png';

const SUNNY_PACKS = [
    { id: 1, amount: 1000, price: "9.99", name: "POCKET SUNNYS", bonus: null, glow: "hover:shadow-[0_0_20px_rgba(255,220,50,0.2)]" },
    { id: 2, amount: 2800, price: "24.99", name: "STASH SUNNYS", bonus: "+300 BONUS", glow: "hover:shadow-[0_0_30px_rgba(255,220,50,0.4)]" },
    { id: 3, amount: 5000, price: "39.99", name: "VAULT SUNNYS", bonus: "+1000 BONUS", glow: "hover:shadow-[0_0_40px_rgba(255,220,50,0.6)]" },
    { id: 4, amount: 13500, price: "99.99", name: "TREASURE SUNNYS", bonus: "BEST VALUE", glow: "hover:shadow-[0_0_60px_rgba(255,220,50,0.8)]", isPopular: true },
];
